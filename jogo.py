...
# ============================================================
# CORREÇÃO PRINCIPAL:
# Algumas funções têm "event" e outras não.
# Agora o sistema descobre automaticamente.
# ============================================================
...
def botao(texto, funcao):
    ...
    try:
        quantidade = len(inspect.signature(funcao).parameters)
    except:
        quantidade = 1

    if quantidade == 0:
        b.onclick = lambda event: funcao()
    else:
        b.onclick = funcao
